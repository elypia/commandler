...
// TODO: Formatted
public class ReflectiveResourceLoader extends FormattedResourceLoader {

    public ReflectiveResourceLoader(InputStream stream) throws IOException {
        super(stream);
    }

    public ReflectiveResourceLoader(Reader reader) throws IOException {
        super(reader);
    }
