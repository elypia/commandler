 ...
 * Due to chat provider being comprised of just text we need
 * a {@link Parser parser} for each data type we're able or want
 ...
 */
public interface Parser<E extends CommandlerEvent, O> {
