...
public class DurationParser implements Parser<CommandlerEvent, Duration> {
    ...
    @Override
    public Duration parse(CommandlerEvent event, ParamData data, Class<? extends Duration> type, String input) {
