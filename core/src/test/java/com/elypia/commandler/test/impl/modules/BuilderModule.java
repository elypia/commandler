...
@Module(name = "Builders", aliases = "builder", help = "Module for testing if builders are performing correctly.")
public class BuilderModule extends Handler<String, String> {
     ...
     */
    @Command(name = "Builders Returned Null", aliases = "null", help = "When a builder returns null for input.")
