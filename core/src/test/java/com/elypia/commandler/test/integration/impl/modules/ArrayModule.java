...
public class ArrayModule implements Handler {
    ...
    public String collectBools(
        @Param(name = "bools", help = "A list of true/false.") boolean[] bools
    ) {
        int trueCount = 0;
    ...
    public String chars(
        @Param(name = "letters", help = "The letters that spell a word.") char[] chars
    ) {
    ...
    public double doubles(
        @Param(name = "numbers", help = "A list of numbers to sum.") double[] numbers
    ) {
    ...
    public long floats(
        @Param(name = "numbers", help = "A list of numbers to sum.") float[] numbers
    ) {
        int floats = 0;
    ...
    public long longs(
        @Param(name = "numbers", help = "A list of numbers to sum.") long[] numbers
    ) {
    ...
    public long shorts(
        @Param(name = "numbers", help = "A list of numbers to sum.") short[] numbers
    ) {
        int shorts = 0;
    ...
    public long bytes(
        @Param(name = "numbers", help = "A list of numbers to sum.") byte[] numbers
    ) {
        int bytes = 0;
    ...
    public int sum(
        @Param(name = "numbers", help = "A list of numbers to sum.") int[] numbers
    ) {
    ...
    public int sum(
        int[] numbers,
        @Param(name = "multiplier", help = "The muliplier to multiply the result by!") int multipler
    ) {
    ...
    public int sum(
        @Param(name = "numbers", help = "A list of numbers to sum.") Integer[] numbers
    ) {
        int total = 0;
