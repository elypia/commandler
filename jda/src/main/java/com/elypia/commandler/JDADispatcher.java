...
public class JDADispatcher extends ListenerAdapter implements IDispatcher<GenericMessageEvent, Message> {
    ...
    public void onMessageReceived(MessageReceivedEvent event) {
        processEvent(event, event.getMessage());
    }
    ...
    @Override
    public Message processEvent(GenericMessageEvent messageEvent) {
        processEvent(messageEvent, msg, msg.getContentRaw());
    }
    ...
    @Override
    public Message processEvent(GenericMessageEvent messageEvent, String content) {
        ...
        try {
            ...
            if (message != null) {
                O m = builder.buildMessage(event, messageEvent);
